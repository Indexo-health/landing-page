...
const sections = [
  { id: 'overview', icon: 'inventory_2', key: 'overview' },
  { id: 'features', icon: 'insights', key: 'features' },
  { id: 'setup', icon: 'build', key: 'setup' },
  { id: 'specs', icon: 'precision_manufacturing', key: 'specs' },
